                        ...
                        return(
                            <Link to={"/product/"+product?._id} className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow ' onClick={scrollTop}>
                                ...
                                <div className='p-4 grid gap-3'>
                                    ...
                                    <div className='flex gap-3'>
                                        <p className='text-[#38a3a5] font-medium'>{ displayCADCurrency(product?.sellingPrice) }</p>
                                        <p className='text-slate-500 line-through'>{ displayCADCurrency(product?.price)  }</p>
                                    </div>
